 ...
 * @array: Shows an array of integers representing a binary tree.
 * @size: The size of the array/tree.
 * @base: Shows the index of the base row of the tree.
 * @root: Shows the root node of the binary tree.
 */
void max_heapify(int *array, size_t size, size_t base, size_t root)
{
